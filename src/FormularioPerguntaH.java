...
public class FormularioPerguntaH extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormularioPerguntaH frame = new FormularioPerguntaH();
	 ...
	 * Create the frame.
	 */
	public FormularioPerguntaH() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(FormularioPerguntaH.class.getResource("/imagens/icons8-help-80.png")));
